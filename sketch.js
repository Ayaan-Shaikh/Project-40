...
function setup() {
 ...
 restart.scale = 0.5;
  ...
  // invisibleGround = createSprite(width/2,height-272,width,125);
  invisibleGround = createSprite(0,235);
...
function draw() {
  ...
  //displaying score
  text("Score: "+ score,windowWidth-460,windowHeight-480);
